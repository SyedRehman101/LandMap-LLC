...
const Home = () => {
 ...
 useEffect(() => {
  ...
  for (let i = 1; i < gridNumber; i++) {
   boxes += '<button  name="btns" style="border-color:#30083D" class="cursor-grab focus:bg-red-600 w-2 h-2 border-t-[0.5px] border-l-[0.5px] border-b-[0.5px] border-r-[0.5px]  flex-none" id="box-' + i + '"></button>'
  }
